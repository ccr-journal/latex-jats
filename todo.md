...
1. [x] Missing XML declaration, DOCTYPE, and root `<article>` attributes (`dtd-version="1.2"`, `xml:lang="en"`, `xmlns:xsi`)
2. [x] MathML namespace prefix is `ns1:` instead of `mml:`
